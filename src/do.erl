...
expr(
    ...
    MonadStack
) when AtomOrVar =:= atom orelse AtomOrVar =:= var ->
...
->
    ...
    {call, Line, {remote, Line1, Monad, {atom, Line1, ReturnOrFail}}, expr_list(As0, MonadStack)};
...
do_syntax(
    [{generate, Line, {var, _Line, _Var} = Pattern, Expr} | Exprs],
    [Monad | _Monads] = MonadStack
) ->
    ...
    [
        {call, Line, {remote, Line, Monad, {atom, Line, '>>='}}, [
            ...
            {'fun', Line, {clauses, [{clause, Line, [Pattern], [], do_syntax(Exprs, MonadStack)}]}}
        ]}
    ];
do_syntax(
